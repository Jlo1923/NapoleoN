package com.naposystems.napoleonchat.source.remote.dto.recoveryOlderAccountQuestions
...
data class RecoveryOlderAccountDTO (
    ...
    companion object {
        fun toUserModel(recoveryOlderAccountDTO: RecoveryOlderAccountDTO, firebaseId: String): UserEntity {
            return UserEntity(
