...
import com.naposystems.napoleonchat.databinding.FragmentTimeFormatDialogBinding
...
class TimeFormatDialogFragment : DialogFragment() {
    ...
    private val viewModel: TimeFormatDialogViewModel by activityViewModels { viewModelFactory }
